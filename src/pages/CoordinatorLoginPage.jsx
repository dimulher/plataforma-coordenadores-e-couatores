...
const CoordinatorLoginPage = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Login Coordenador - NAB Platform</title>
            </Helmet>
                ...
                <div className="w-full max-w-md">
                    <div className="bg-white rounded-2xl shadow-2xl p-8">
                        ...
                        <div className="text-center mb-8">
                            ...
                            <h1 className="text-2xl font-bold text-slate-800">Portal do Coordenador</h1>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            >
                                {isLoading ? (
                                    ...
                                    <><LogIn className="h-5 w-5 mr-2" /> Entrar como Coordenador</>
                                )}
                            </Button>
                        </form>

                        <div className="mt-6 pt-6 border-t border-slate-100 space-y-2 text-center text-sm text-slate-500">
                            <p><Link to="/login/coautor" className="text-purple-600 hover:underline font-medium">Sou Coautor →</Link></p>
