...
const AdminCoordinatorDetailPage = () => {
  ...
  if (!coordinator) return (
    <div className="flex h-64 items-center justify-center" style={{ color: `${NAV}70` }}>Coordenador não encontrado.</div>
  );
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs" style={{ color: `${NAV}72` }}>{coordinator.email} · Funil de leads — arraste para mover</p>
              </div>
            </div>
          </div>
                  ...
                  <div className="flex-1 overflow-y-auto space-y-2 pr-1 pb-2">
                    {colLeads.map(lead => (
                      ...
                      >
                        ...
                        {lead.email && <p className="text-xs truncate" style={{ color: `${NAV}65` }}>{lead.email}</p>}
                      </div>
                    ))}
                    {colLeads.length === 0 && (
