...
import { Edit3, Send, Eye, AlertCircle, CheckCircle, Award, Clock } from 'lucide-react';
...
const STATUS_CONFIG = {
  ...
  AGUARDANDO_APROVACAO_COAUTOR: { label: 'Aguardando Aprovação', color: 'bg-purple-100 text-purple-800 border-purple-300', icon: Clock },
